# OPTIMA_SCLC_CohortDiagnostics
This code is designed to run cohort diagnostics on the following outcome cohorts for the OPTIMA Research Question 16 on treatment patterns of SCLC:
- SCLC cancer (overall, very limited, limited, extensive and stages 1-4)
- Radiotherapy
